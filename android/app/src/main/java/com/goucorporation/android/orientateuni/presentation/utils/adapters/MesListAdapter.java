...
public class MesListAdapter extends BaseExpandableListAdapter {

    private List<String> titles;
    private List<List<String>> contents;
    private LayoutInflater inflater;

    public MesListAdapter(Context context, List<String> titles, List<List<String>> contents) {
        this.titles = titles;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            convertView = inflater.inflate(R.layout.group_item_meses,null);
        }
        ...
        if(convertView == null){
            switch (childPosition){
                case 0:
                    ...
                    break;
                case 1:
                    convertView = inflater.inflate(R.layout.child_item_junio,null);
                    break;
                case 2:
                    convertView = inflater.inflate(R.layout.child_item_julio,null);
                    break;
                default:
